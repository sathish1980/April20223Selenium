...
public class WinidowsHandle {
	...
	public void windowshandlingimplementation()
	{
		...
		Set<String> AllWindow=driver.getWindowHandles(); //all windows open by automation at that instance
	...
	public static void main(String[] args) {
		...
		WinidowsHandle W = new WinidowsHandle();
